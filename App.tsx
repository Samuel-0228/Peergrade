    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 py-10 lg:px-8 xl:max-w-screen-2xl bg-black font-sans">
      ...
      <header className="fade-up relative overflow-hidden rounded-none border border-neutral-800 bg-black px-6 py-16 md:px-12 md:py-24">
        <div className="relative z-10 max-w-4xl text-left">
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-neutral-800 bg-neutral-900 px-4 py-1.5 text-xs font-semibold uppercase tracking-widest text-neutral-400 transition-all hover:bg-neutral-800 hover:scale-105">
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-neutral-400 md:text-xl">
          ...
          <div className="mt-12 grid max-w-3xl grid-cols-2 gap-4 sm:grid-cols-3">
            <div className="flex flex-col items-start justify-center rounded-none border border-neutral-800 bg-neutral-900/50 p-6 transition-all hover:bg-neutral-800 hover:-translate-y-1">
            ...
            <div className="col-span-2 sm:col-span-1 flex flex-col items-start justify-center rounded-none border border-neutral-800 bg-neutral-900/50 p-6 transition-all hover:bg-neutral-800 hover:-translate-y-1">
      ...
      <section className="fade-up mt-24 mb-16" style={{ animationDelay: '0.1s' }}>
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3 lg:gap-12 relative">
          ...
          <div className="group relative z-10 flex flex-col items-center text-center bg-black transition-transform duration-300 hover:-translate-y-2">
            <div className="mb-6 flex h-16 w-16 items-center justify-center rounded-none bg-black border border-neutral-800 transition-all duration-300 group-hover:bg-white group-hover:text-black group-hover:scale-110 text-white">
              <Database className="h-8 w-8 transition-transform duration-300 group-hover:-rotate-12" />
            </div>
          ...
          <div className="group relative z-10 flex flex-col items-center text-center bg-black transition-transform duration-300 hover:-translate-y-2">
            <div className="mb-6 flex h-16 w-16 items-center justify-center rounded-none bg-black border border-neutral-800 transition-all duration-300 group-hover:bg-white group-hover:text-black group-hover:scale-110 text-white">
              <LineChartIcon className="h-8 w-8 transition-transform duration-300 group-hover:rotate-12" />
            </div>
      ...
      <div className="fade-up mt-8 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3" style={{ animationDelay: '0.3s' }}>
        <div className="group col-span-1 rounded-none border border-neutral-800 bg-neutral-950 p-8 lg:col-span-2 transition-all duration-300 hover:bg-neutral-900 hover:-translate-y-1">
          <h3 className="flex items-center gap-2 text-xl font-bold text-white tracking-tight uppercase">
            <Cpu className="h-5 w-5 text-white transition-transform duration-300 group-hover:rotate-180" /> Built for insight over decoration
          </h3>
        ...
        <div className="group col-span-1 flex flex-col justify-between rounded-none border border-neutral-800 bg-neutral-950 p-8 transition-all duration-300 hover:bg-neutral-900 hover:-translate-y-1">
          <div>
            ...
            <h3 className="mt-3 flex items-center gap-2 text-lg font-bold text-white tracking-tight uppercase">
              <ShieldCheck className="h-5 w-5 text-white transition-transform duration-300 group-hover:scale-110" />
              Verified Records
            </h3>
            <p className="mt-4 text-sm leading-relaxed text-neutral-400">
          ...
          <button className="mt-6 inline-flex w-full items-center justify-center gap-2 rounded-none bg-white px-4 py-3 text-sm font-bold uppercase text-black transition-all hover:bg-neutral-200 hover:gap-3">
            Explore workspace
