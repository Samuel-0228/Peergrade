...
const DashboardItem: React.FC<{ col: SurveyColumn, responses: RawResponse[], description: string, theme: AppTheme }> = ({ col, responses, description, theme }) => {
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-6 duration-700">
      ...
      <div className={`glass p-10 rounded-[4rem] border-white/5 flex flex-col items-center gap-12 shadow-2xl relative transition-all duration-500 ${showDeepDive ? 'scale-[1.01] border-white/20' : ''}`}>
